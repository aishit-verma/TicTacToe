...
public class GameManager : NetworkBehaviour
{
    ...
    public struct Line
    {
        ...
        public Vector2Int centreGridPosition;
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("Multiple instances of GameManager detected. Destroying duplicate.");
        }
        else
        {
            Instance = this;
        ...
        {      //Horizontal lines
            new Line
            {
                ...
                centreGridPosition = new Vector2Int(1, 0),
            ...
            new Line
            {
                ...
                centreGridPosition = new Vector2Int(1, 1),
                orientation = Orientation.Horizontal
            },
            new Line
            {
                ...
                centreGridPosition = new Vector2Int(1, 2),
                orientation = Orientation.Horizontal
            },
            //Vertical lines
            new Line
            {
                ...
                centreGridPosition = new Vector2Int(0, 1),
            ...
            new Line
            {
                ...
                centreGridPosition = new Vector2Int(2, 1),
                orientation = Orientation.Vertical
            },
            //Diagonal lines
            new Line
    ...
    private void TestWinner()
    {
        for (int i = 0; i < lineList.Count; i++)
        {
            ...
            if (TestWinnerLine(line))
            {
                ...
                PlayerType winPlayerType = playerTypeArray[line.centreGridPosition.x, line.centreGridPosition.y];
